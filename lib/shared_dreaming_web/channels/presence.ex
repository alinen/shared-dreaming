defmodule SharedDreamingWeb.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule SharedDreaming.MyChannel do
        use SharedDreamingWeb, :channel
        alias SharedDreaming.Presence
  ...
  """
  use Phoenix.Presence, otp_app: :shared_dreaming,
                        pubsub_server: SharedDreaming.PubSub
end
